...
#' @title Colour palette for a categorical trend variable with 2 values for points.
#' @description Colour palette for categorical variables.
#' @return A vector of hex codes.
#' @export
#' @examples
...
#' @title Colour palette for a categorical trend variable with 3 values for points.
#' @description Colour palette for categorical variables.
#' @return A vector of hex codes.
#' @export
#' @examples
#' scales::show_col(pal_point_trend3)
pal_point_trend3 <- c("#4575B4", "#C4C4C7", "#D73027")
...
pal_point_trend5 <- c("#4575B4", "#90C3DD", "#C4C4C7", "#F98E52", "#D73027")